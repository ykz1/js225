...
Doctor.prototype.diagnose = function() {
  console.log(`Dr. ${this.fullName()} (age ${this.age}), ${this.specialization}, is checking your vitals...`);
}
let feynman = new Doctor('Richard', 'Feynman', 24, 'male', 'Physics');
feynman.diagnose();
feynman.eat();
...
Professor.prototype.teach = function() {
  console.log(`Prof. ${this.fullName()} (age ${this.age}) is teaching ${this.subject}.`)
}
let richard = new Professor('Richard', 'Feynman', 27, 'male', 'Theoretical Physics');
richard.teach();
richard.communicate();
...
Student.prototype.study = function() {
  console.log(`Student ${this.fullName()} (age ${this.age}) is sleepy from studying for his ${this.degree} degree`)
}
rick = new Student('Richard', 'Feynman', 17, 'male', 'Bachelor of Science');
rick.study();
rick.sleep();
...
GraduateStudent.prototype.research = function() {
  console.log(`${this.fullName()} has completed his ${this.degree}, and is now falling asleep researching for his ${this.graduateDegree}`);
}
let rf = new GraduateStudent('Richard', 'Feynman', 21, 'male', 'Bachelor of Science', 'Ph.D. in Physics')
rf.study();
rf.research();
rf.sleep();
